...
namespace FortuneTeller
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (age % 2 == 1)
            {
                retirement = " not retire in ";
            }           
                else
                {
                retirement = " retire in ";
                }

            //vacation home based on siblings count
            vacationLocation = "Cleveland, OH";
            ...
            {
                vacationLocation = "Jacksonville, NC";
            }


            //Color-based transportation...
            transport = "Bad Color Choice";
            ...
            if ((birthMonth >= 1) && (birthMonth <= 4))
                ...
                //Fortune Presented
                Console.WriteLine(firstName + " " + lastName + " will" + retirement + retireAge + " years with " + bankMoney + " in the bank, a vacation home in " + vacationLocation + " and a " + transport + ".");
